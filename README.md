...
[This code in in example/fair_flow_example.py]
...
# Behind the scenes
Fairflow communicates jobs and processes in a language known as [DOT](https://www.graphviz.org/).  DOT describes activities as nodes, and decisions as lines.  This way, we can easily describe what needs to be done.
...
# Getting Started
There is a demo available in the Fairflow directory with the command
